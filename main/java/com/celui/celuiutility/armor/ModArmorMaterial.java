package com.celui.celuiutility.armor;
...
public enum ModArmorMaterial implements IArmorMaterial {
    ...
    TUNGSTEN( Celui.MOD_ID + ":tungsten", 40, new int[] { 6, 8, 10, 6, }, 24, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC,
            3.0F, () -> { return Ingredient.fromItems(RegistryHandler.TUNGSTEN_INGOT.get()); }, 1);

    private static final int[] MAX_DAMAGE_ARRAY = new int[] { 8, 11, 12, 9 };
